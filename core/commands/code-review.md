# `/code-review` — Manual Code Review Pass

Independent review of the implemented code. Runs after `/run-gates` passes but before `/create-mr`. Catches issues automated analyzers miss: semantic correctness, naming clarity, dead code, design smell.

## Usage

```
/code-review DEV-XXXX
```
...
[Approved]: Proceed to /create-mr.
[Not approved]: Address blocker/critical issues and re-run /code-review.
```

## What this command does NOT do

- ❌ Modify code. Review only — issues are reported.
- ❌ Replace `/run-gates`. Gates check static rules; this is the human-flavored review.
